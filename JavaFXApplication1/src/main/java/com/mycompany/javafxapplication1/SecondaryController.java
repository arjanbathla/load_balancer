...
public class SecondaryController {
    ...
    private void ChangeButton()
    {
        ...
        Stage ChangePasswordStage = (Stage) secondaryButton.getScene().getWindow();
        try {
    ...
    {
        Stage secondaryStage = new Stage();
        Stage fileManagementStage = (Stage) secondaryButton.getScene().getWindow();
        try {
            ...
            Scene scene = new Scene(root, 640, 480);
            secondaryStage.setScene(scene);
            secondaryStage.setTitle("FileManagement");
            secondaryStage.show();
